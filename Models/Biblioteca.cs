...
{
    "Fuegos de octubre (3:58)", "Preso en mi ciudad (4:35)", "Motor psico (3:47)", "Jijiji (5:23)", "Canción para naufragios (4:05)",
    "Kiss (4:28)", "Amo (4:45)", "El rey del falsete (4:00)", "El llanto (5:11)", "La vida (5:24)"
};
        ...
        List<string> canciones2 = new List<string>
{
    "Signos (5:14)", "Prófugos (4:51)", "Persiana americana (4:55)", "El rito (3:42)", "Final caja negra (4:20)",
    "En el borde (3:32)", "Te hacen falta vitaminas (3:45)", "Despedir al que se va (5:20)"
};
        ...
        List<string> canciones3 = new List<string>
{
    "El amor después del amor (4:33)", "Dos días en la vida (4:20)", "Tumbas de la gloria (4:45)", "La rueda mágica (3:55)", "Brillante sobre el mic (4:10)",
    "El amor después del amor (Reprise) (2:22)", "Escuelas de calor (3:48)", "Lo que está en la cabeza (5:23)", "La letra del fin del mundo (3:19)"
};
        ...
        List<string> canciones4 = new List<string>
{
    "Peperina (4:52)", "Esperando nacer (3:49)", "José Mercado (4:03)", "Cinema verité (3:58)", "Salir de la melancolía (4:11)",
    "Los libros de la buena memoria (4:40)", "Despedida (3:34)"
};
        ...
        List<string> canciones5 = new List<string>
{
    "Maradó (4:31)", "Verano del '92 (3:59)", "El balneario de los doctores crotos (4:26)", "Ay ay ay (3:44)", "Media caña (4:10)",
    "La zurda (5:02)", "Quiero creerte (3:25)", "Azul (4:01)", "Bajo el sol (4:29)"
};
        ...
        List<string> canciones6 = new List<string>
{
    "We Don't Care (3:59)", "Through the Wire (3:41)", "Slow Jamz (5:16)", "All Falls Down (3:43)", "Jesus Walks (3:13)",
    "Never Let Me Down (4:47)", "Get Em High (3:26)", "Work Out Plan (4:06)", "The New Workout Plan (5:10)",
    "Last Call (6:17)"
};
        ...
        List<string> canciones7 = new List<string>
{
    "Heard 'Em Say (3:23)", "Touch the Sky (3:56)", "Gold Digger (3:27)", "Diamonds from Sierra Leone (3:59)", "Drive Slow (4:32)",
    "My Way Home (4:35)", "Crack Music (3:39)", "Roses (4:05)", "Bring Me Down (4:16)", "Addiction (4:39)",
    "Skit #1 (1:10)", "Skit #2 (0:52)", "Hey Mama (3:58)", "Celebration (3:43)"
};
        ...
        List<string> canciones8 = new List<string>
{
    "Good Morning (3:15)", "Champion (3:05)", "Stronger (5:12)", "I Wonder (4:03)", "Good Life (4:30)",
    "Can't Tell Me Nothing (4:29)", "Drunk and Hot Girls (4:32)", "Flashing Lights (3:58)", "Everything I Am (3:45)",
    "The Glory (4:32)", "Homecoming (3:24)", "Big Brother (4:38)"
};
        ...
        List<string> canciones9 = new List<string>
{
    "Say You Will (6:18)", "Welcome to Heartbreak (4:25)", "Heartless (3:31)", "Amazing (3:52)", "Love Lockdown (4:30)",
    "Paranoid (4:37)", "Robocop (4:34)", "Street Lights (3:52)", "Bad News (3:45)", "See You in My Nightmares (4:29)",
    "Colder Than Winter (3:28)"
};
        ...
        List<string> canciones10 = new List<string>
{
    "Dark Fantasy (4:41)", "Gorgeous (5:56)", "Power (3:41)", "All of the Lights (4:59)", "Monster (6:18)",
    "So Appalled (6:38)", "Devil in a New Dress (5:52)", "Runaway (9:08)", "Hell of a Life (6:23)", "Blame Game (7:49)",
    "Lost in the World (4:16)", "Who Will Survive in America (1:16)"
};
        ...
        List<string> canciones11 = new List<string>
{
    "On Sight (2:37)", "Black Skinhead (3:08)", "I Am a God (4:50)", "New Slang (3:10)", "Hold My Liquor (6:19)",
    "I'm In It (3:56)", "Blood on the Leaves (6:00)", "Guilt Trip (5:49)", "Send It Up (3:21)", "Bound 2 (3:49)"
};
        ...
        List<string> canciones12 = new List<string>
{
    "Ultralight Beam (5:20)", "Father Stretch My Hands Pt. 1 (2:15)", "Father Stretch My Hands Pt. 2 (2:13)", "Famous (3:16)", "Feedback (2:42)",
    "Low Lights (1:12)", "Highlights (3:13)", "Waves (3:01)", "FML (3:58)", "Real Friends (4:10)",
    "Wolves (5:38)", "Silver Surfer Intermission (1:47)", "30 Hours (2:53)", "No More Parties in LA (6:06)",
    "Facts (2:43)", "Fade (3:13)"
};
        ...
        List<string> canciones13 = new List<string>
{
    "Selah (2:44)", "Follow God (1:44)", "Closed on Sunday (2:31)", "Everything We Need (1:57)", "Jesus Is Lord (0:49)"
};
