...
public class Biblioteca
{
    ...
    public static Dictionary<int, Disco> InicializarBiblioteca()
    {
        ...
        DatoDisco datosDisco1 = new DatoDisco("Oktubre", "Segundo álbum de Los Redondos, con un sonido más político y oscuro.", 850000, canciones1, "Carlos Alomar", "Patricio Rey y sus Redonditos de Ricota");
        ...
        DatoDisco datosDisco2 = new DatoDisco("Signos", "Tercer disco de Soda Stereo, una obra clave del rock en español.", 1500000, canciones2, "Charly Alberti", "Soda Stereo");
        ...
        DatoDisco datosDisco3 = new DatoDisco("El amor después del amor", "Uno de los discos más vendidos del rock argentino.", 2200000, canciones3, "Fito Páez", "Fito Páez");
        ...
        DatoDisco datosDisco4 = new DatoDisco("Peperina", "Último disco de estudio de Serú Girán, con letras más directas.", 730000, canciones4, "Charly García", "Serú Girán");
        ...
        DatoDisco datosDisco5 = new DatoDisco("Azul", "Uno de los discos más populares de Los Piojos, con sonidos más latinos.", 680000, canciones5, "Gustavo Lamas", "Los Piojos");
